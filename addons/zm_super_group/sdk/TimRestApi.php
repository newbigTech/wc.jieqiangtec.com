...
class TimRestAPI extends TimRestInterface
{
	...
	public function getSignature(){
	    if(is_64bit()){
	        if(PATH_SEPARATOR==':'){
	            $signature = "linux-signature64";
	        }else{
	            $signature = "windows-signature64.exe";
	        }
	    }else{
	        if(PATH_SEPARATOR==':')
	        {
	            $signature = "linux-signature32";
	        }else{
	            $signature = "windows-signature32.exe";
	        }
	    }
	    return IA_ROOT.'/attachment/zm_super_group/tool/'.$signature;
	}
	...
	function group_get_appid_group_list2($limit, $offset, $group_type = 'Public')
	{
	...
	function group_create_group2($group_type, $group_name, $owner_id, $info_set, $mem_list = null)
	{
	...
	function group_modify_group_base_info2($group_id, $group_name, $info_set, $app_define_list = array())
	{
	...
	function group_add_group_member($group_id, $member_id, $silence = 0)
	{

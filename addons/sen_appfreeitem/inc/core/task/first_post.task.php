...
$sql = "SELECT id FROM ".tablename('intelligent_kindergarten_topics')." WHERE uid = :uid AND uniacid = :uniacid";
...
if($done) {
	...
	$url = murl('entry',array('m'=>'intelligent_kindergarten','do'=>'forum_post'));
	//任务完成向导

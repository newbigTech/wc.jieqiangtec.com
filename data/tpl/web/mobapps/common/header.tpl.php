...
<section id="container" class="">    
    <!--header start-->
      <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="<?php  echo url('accound/display');?>" class="logo"><span>人人店</span></a>
            <!--logo end-->            
            <div class="top-nav ">
                <!--user info start-->
 ...
 <!--<li><a href="<?php echo $_W['siteroot'].'web/index.php?c=home&a=welcome&do=ext&m=ewei_shop'?>"><i class="fa fa-umbrella"></i> 人人店管理</a></li>-->
        <!--     <li><a href="<?php echo $_W['siteroot'].'web/index.php?c=site&a=entry&method=cover&p=commission&do=plugin&m=ewei_shop'?>"><i class="fa fa-umbrella"></i>分销</a></li>  --> 
 
  <?php  if(!empty($_W['isfounder']) || empty($_W['setting']['permurls']['sections']) || in_array('platform', $_W['setting']['permurls']['sections'])) { ?><li<?php  if(FRAME == 'platformss') { ?> class="active"<?php  } ?> id="liebiaoyuanss"><a href="<?php echo $_W['siteroot'].'web/index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=shop'?>" target="_blank"><i class="fa fa-users"></i>人人店</a></li><?php  } ?>

	...
	<form class="we7-form user-group-edit" method="post" action="">
		...
		<div class="panel we7-panel">
			<div class="panel-heading">
				选择应用权限套餐组
				<a href="<?php  echo url('system/module-group/post')?>" class="color-default pull-right">新建应用权限套餐组</a>
			</div>
				...
				<div ng-repeat="pack in packages">
					...
					<table id="demo-{{pack.id}}" class="table we7-table table-hover collapse">
						...
						<tr class="permission-apply">
							...
							<td><ul><li ng-repeat="wxapp in pack.wxapp"><span class="label label-info" ng-bind="wxapp.title"></span></li></ul></td>
						</tr>

...
<form  class="form-box" method="post" role="form">    <div class="new-bg"></div>
    <div class="xiaokeduo-login-container" style="top:40%;left: 65%;width: 360px;">
        <!-- <div class="qr-code">
            <div class="qr-code-content">
                ...
                <p class="text">扫一扫加入官方公众号立即体验22222</p>
            </div>
        </div> -->
...
<?php  } ?>
    ...
    <div class="subfooter">
        ...
        <p><small class="text-muted"><font color="#NaNNaNNaN"><?php  if(empty($_W['setting']['copyright']['footerleft'])) { ?>Powered by v<?php echo IMS_VERSION;?> &copy; 2017-20122 <?php  } else { ?><?php  echo $_W['setting']['copyright']['footerleft'];?><?php  } ?></small></p>

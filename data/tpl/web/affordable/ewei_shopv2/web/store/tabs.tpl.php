...
<ul>
    <?php if(cv('store')) { ?><li <?php  if($_W['action'] == 'store'||$_W['action'] == 'store.add'||$_W['action'] == 'store.edit'||$_W['action'] == 'store.diypage.page'||$_W['routes'] == 'store.diypage.settings') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('store')?>">门店管理</a></li><?php  } ?>
...
<ul>
    ...
    <?php  } ?>
    <?php if(cv('store.verifygoods')) { ?><li <?php  if($_W['action'] == 'store.verifygoods') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('store/verifygoods')?>">核销商品核销管理</a></li><?php  } ?>
</ul>

<div class='menu-header'>统计</div>
<ul>
    <?php if(cv('store.verifylog')) { ?><li <?php  if($_W['action'] == 'store.verify') { ?> class="active" <?php  } ?>><a href="<?php  echo webUrl('store/verify/log')?>">核销商品统计</a></li><?php  } ?>
</ul>
<?php  } ?>

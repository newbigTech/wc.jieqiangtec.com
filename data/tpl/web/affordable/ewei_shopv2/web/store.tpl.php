                ...
                <tbody>
                    ...
                    <?php  } ?>
                        ...
                        <td>
						  ...
						  <a class='btn btn-default btn-sm' href="<?php  echo webUrl('store/edit', array('id' => $row['id']))?>"><i class='fa fa-edit'></i> <?php if(cv('shop.verify.store.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?></a><?php  } ?>
                          <?php if(cv('store.delete')) { ?><a class='btn btn-default  btn-sm' data-toggle="ajaxRemove"  href="<?php  echo webUrl('store/delete', array('id' => $row['id']))?>" data-confirm="确认删除此门店吗？"><i class='fa fa-trash'></i> 删除</a><?php  } ?>

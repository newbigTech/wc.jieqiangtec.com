...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <label class="radio-inline"><input type="radio" name="type" value="5" <?php  if(!empty($item['id'])) { ?>disabled<?php  } ?>  <?php  if($item['type'] == 5) { ?>checked="true"<?php  } ?>  onclick="type_change(5);" /> 核销商品</label>
...
<div class="form-group send-group" style="<?php  if($item['type'] != 2) { ?>display: none;<?php  } ?>">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('goods' ,$item) ) { ?>
        <label class="radio-inline"><input type="radio" name="virtualsend" value="0"  <?php  if(empty($item['virtualsend'])) { ?>checked="true"<?php  } ?>  onclick="type_change(2);"/> 否</label>
        <label class="radio-inline"><input type="radio" name="virtualsend" value="1" <?php  if($item['virtualsend'] == 1) { ?>checked="true"<?php  } ?>  onclick="type_change(2);"/> 是</label>
...
<div class="form-group splitter dispatch_info" <?php  if(($item['type'] == 2 || $item['type'] == 3 || $item['type'] == 10)) { ?>style="display: none;"<?php  } ?>></div>
<div class="form-group dispatch_info" <?php  if(($item['type'] == 2 || $item['type'] == 3 || $item['type'] == 5 || $item['type'] == 10)) { ?>style="display: none;"<?php  } ?>>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if( ce('goods' ,$item) ) { ?>
        <label class="checkbox-inline" <?php  if($item['isverify'] == 2 || $item['type'] == 2 || $item['type'] == 3|| $item['type'] == 5) { ?>style="display:none;"<?php  } ?>>

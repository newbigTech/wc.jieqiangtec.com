...
<div class="wrapper" style="width: auto;">
	...
	<div class="control" style="width: 450px; padding: 10px;border: 1px solid #d0d1d2">
		<div class="editor_section">
			...
			<div class="control-group limit">
				...
				<div class="frm_controls">
					...
					<input type="text" name="card_brand_name" id="card_brand_name" class="input" value="<?php  echo $card['card_brand_name'];?>" <?php  if(!empty($card)) { ?>disabled<?php  } ?> />
					<?php  } else { ?>
			...
			<div class="control-group limit">
				...
				<div class="frm_controls">
					<?php if(cv('member.card')) { ?>
					<input type="text" name="card_title" id="card_title" class="input" value="<?php  echo $card['card_title'];?>" <?php  if(!empty($card)) { ?>disabled<?php  } ?> />
					<?php  } else { ?>
			...
			<div class="control-group limit">
				...
				<div class="frm_controls">
					<?php if(cv('member.card')) { ?>
					<input type="text" name="card_totalquantity" id="card_totalquantity" class="input" value="<?php  echo $card['card_totalquantity'];?>" <?php  if(!empty($card)) { ?>disabled<?php  } ?> />
					<?php  } else { ?>
			...
			<div class="control-group">
				...
				<div class="frm_controls">
					<div class="frm-image">
						...
						<img  id="showlogo"  style="border-radius: 50%"  src="<?php  if(empty($card)) { ?>../addons/ewei_shopv2/static/images/default.png<?php  } else { ?><?php  echo $card['card_logoimg'];?><?php  } ?>" />
					</div>
				</div>
				<div class="frm_controls">
		...
		<div class="control-group">
			...
			<?php if(cv('member.card')) { ?>
			<div class="frm_controls">
				<textarea  name="prerogative" rows="5" cols="35"><?php  echo $card['prerogative'];?></textarea>
		...
		<div class="control-group">
			...
			<?php if(cv('member.card')) { ?>
			<div class="frm_controls">
				<textarea  name="card_description" rows="5" cols="35"><?php  echo $card['card_description'];?></textarea>
				<p class='frm_tip'>文本长度不能超过300字</p>
			</div>
			<?php  } else { ?>

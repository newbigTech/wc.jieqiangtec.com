...
<div class="page-heading">
    ...
    <h2><?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>商品 <small><?php  if(!empty($item['id'])) { ?>修改【<span class="text-info"><?php  echo $item['title'];?></span>】<?php  } ?><?php  if(!empty($merch_user['merchname'])) { ?>商户名称:【<span class="text-info"><?php  echo $merch_user['merchname'];?></span>】<?php  } ?></small></h2>
</div>
    ...
    <div class="tabs-container tab-goods">
        <div class="tabs-left">
            <ul class="nav nav-tabs" id="myTab">
                ...
                <?php  } ?>
                <?php  if($merchid == 0 && $showverify) { ?>
                <li <?php  if($_GPC['tab']=='verify') { ?>class="active"<?php  } ?> id="tab_nav_verify" <?php  if($item['type']==3||($item['type']==2&&!empty($item['virtualsend']))) { ?>style="display:none;"<?php  } ?>><a href="#tab_verify">线下核销</a></li>
                <?php  } ?>
				...
				<li <?php  if($item['type'] != 5) { ?>style="display:none;"<?php  } ?>   class="showverifygoods" <?php  if($_GPC['tab']=='verifygoods') { ?>class="active"<?php  } ?> ><a href="#tab_verifygoods">核销类商品规则</a></li>
				<?php  if(com('wxcard')) { ?>
				<li <?php  if($item['type'] != 5) { ?>style="display:none;"<?php  } ?>   class="showverifygoodscard"  <?php  if($_GPC['tab']=='verifygoodscard') { ?>class="active"<?php  } ?> ><a href="#tab_verifygoodscard">核销类商品会员卡</a></li>
				<?php  } ?>
            </ul>
            ...
            <div class="tab-content ">
                ...
                <?php  if($merchid == 0 && $showverify) { ?>
                <div class="tab-pane <?php  if($_GPC['tab']=='verify') { ?>active<?php  } ?>" id="tab_verify"  <?php  if($item['type']==3||($item['type']==2&&!empty($item['virtualsend']))) { ?>style="display:none;"<?php  } ?>> <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('goods/tab/verify', TEMPLATE_INCLUDEPATH)) : (include template('goods/tab/verify', TEMPLATE_INCLUDEPATH));?></div></div>
                <?php  } ?>
